  ...
  <div class="navbar-start">
    <div class="dropdown">
      ...
      <ul tabindex="0" class="menu menu-compact dropdown-content mt-3 p-2 shadow bg-base-100 rounded-box w-52">
        ...
        <li><router-link to="/appointmentbooking">Appointment Booking</router-link></li>
      </ul>
    </div>
    ...
    <ul class="menu menu-horizontal p-0">
      ...
      <li tabindex="0">
        ...
        <ul class="p-2 bg-white shadow-lg">
          <li><router-link to="">Repair</router-link></li>
          <li><router-link to="/appointmentbooking">Maintenance</router-link></li>
        </ul>
      </li>
      <li><router-link to="/appointmentbooking">Appointment Booking</router-link></li>
    </ul>
